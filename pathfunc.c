...
/**
 * _getpath - Finds the PATH variable from enviroment
...
/**
 * _include_path - Inserts the directory into given command
 * @args: given command
...
/**
 * split_dir - Creates an array of pointers to the PATH directories
 * @buffer: given string
 * Return: Pointer to an array of tokenized directories
*/
